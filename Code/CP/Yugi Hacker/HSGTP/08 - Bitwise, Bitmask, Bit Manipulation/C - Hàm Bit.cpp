...
#define IMIN INT_MIN / 2
#define UIMIN UINT_MIN / 2
#define LLMIN LLONG_MIN / 2
#define ULLMIN ULLONG_MIN / 2
...
void Solve() {
    cin >> n;
    PRINTS(popcount((uint)n), 31 - countl_zero((uint)n), countr_zero((uint)n));
    return;
}
