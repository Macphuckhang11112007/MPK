...
- 💾 Repository Locations:
    🌐 Remote Repository   : https://github.com/Macphuckhang11112007/Code/tree/main/CP\TopAlgo\Month_01\Lesson_04\02_KMIN_VNOJ.cpp
    🖥️ Local Repository    : C:/Users/macph/Downloads/MPK/Code/CP/TopAlgo/Month_01/Lesson_04/02_KMIN_VNOJ.cpp
- 📄 File Name             : 02_KMIN_VNOJ.cpp
- 🗓️ Creation Date         : 12:00 08-07-2025
- 💻 Coding Time           : HH:MM
...
signed main ()
{
    ...
    while (tc--)
    {
        ...
        while (k--)
        {
            int x, i, j; tie (x, i, j) = pq.top ();  pq.pop ();
            cout << x << endl;
            if (i < n) pq.ep (a [i + 1] + b [j], i + 1, j);
        }
    }
    return 0;
}