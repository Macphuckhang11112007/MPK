...
- 💾 Repository Locations:
    🌐 Remote Repository   : https://github.com/Macphuckhang11112007/Code/tree/main/CP\TopAlgo\Month_01\Lesson_04\01_Add-All_VJ.cpp
    🖥️ Local Repository    : C:/Users/macph/Downloads/MPK/Code/CP/TopAlgo/Month_01/Lesson_04/01_Add-All_VJ.cpp
- 📄 File Name             : 01_Add-All_VJ.cpp
- 🗓️ Creation Date         : 10:43 08-07-2025
- 💻 Coding Time           : HH:MM
...
2. 🎯 PROBLEM STATEMENT
─────────────────────────────────────────────────────────────────
- 🌟 Problem Title         : 01_Add-All_VJ
- 🆔 Problem ID            : 10954
- 🔗 Problem URL           : https://vjudge.net/problem/UVA-10954
...
signed main ()
{
    ...
    while (tc--)
    {
        ...
        while (cin >> n && n)
        {
            ...
            while (sz (pq) > 1)
            {
                int x; x = pq.top (); pq.pp ();
                int y; y = pq.top (); pq.pp ();
                ans += x + y;
                pq.ep (x + y);
            }
            cout << ans << endl;
