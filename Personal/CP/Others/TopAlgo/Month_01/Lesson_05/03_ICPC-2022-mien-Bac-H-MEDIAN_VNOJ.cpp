...
- 💾 Repository Locations:
    🌐 Remote Repository   : https://github.com/Macphuckhang11112007/Code/tree/main/CP\TopAlgo\Month_01\Lesson_05\03_ICPC-2022-mien-Bac-H-MEDIAN_VNOJ.cpp
    🖥️ Local Repository    : C:/Users/macph/Downloads/MPK/Code/CP/TopAlgo/Month_01/Lesson_05/03_ICPC-2022-mien-Bac-H-MEDIAN_VNOJ.cpp
- 📄 File Name             : 03_ICPC-2022-mien-Bac-H-MEDIAN_VNOJ.cpp
- 🗓️ Creation Date         : 12:34 12-07-2025
- 💻 Coding Time           : HH:MM
...
2. 🎯 PROBLEM STATEMENT
─────────────────────────────────────────────────────────────────
- 🌟 Problem Title         : 03_ICPC-2022-mien-Bac-H-MEDIAN_VNOJ
...
signed main ()
{
    ...
    while (tc--)
    {
        ...
        else if (str == "MEDIAN") cout << (ok ? *prev (s1.end ()) : (*prev (s1.end ()) + *s2.begin ()) / 2.0) << endl;
    }
    return 0;
}